...
const Messages = ({ fileId }: MessagesProps) => {
  ...
  return (
    <div className='flex max-h-[calc(100svh-3.5rem-7rem)] border-zinc-200 flex-1 flex-col-reverse gap-4 overflow-y-auto p-3 scrollbar-thumb-gray scrollbar-thumb-rounded scrollbar-track-gray-lighter scrollbar-w-2 scrolling-touch'>
